...
| `FAC_servo_set_position` | Sets and applies position `0 … MAX_SERVO_VALUE`, mapped into the configured `[min_us, max_us]` pulse window. Reversal applied internally. ⚠ See issue #7. |
